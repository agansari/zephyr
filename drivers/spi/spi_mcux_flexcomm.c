			      ...
			      const struct spi_config *spi_cfg)
{
	...
	master_config.delayConfig.preDelay = 0x3;
    master_config.delayConfig.postDelay = 0x3;
    master_config.delayConfig.frameDelay = 0x0;
    master_config.delayConfig.transferDelay = 0x0;
